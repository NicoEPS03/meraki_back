...
public interface IUserRepo extends JpaRepository<User, Integer> {
    ...
    @Query(value = "SELECT * FROM public.User u WHERE u.usr_state = true", nativeQuery = true)
    public Page<User> findAllStateTrue(Pageable pageable);

    @Query(value = "SELECT * FROM public.User u WHERE u.usr_document = :document AND NOT u.usr_id = :id", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM public.User u WHERE u.usr_document = :document AND u.usr_password = :password AND u.usr_state = true", nativeQuery = true)
